...
**⚠️ CRITICAL: Before responding to ANY request, @arog MUST:**
1. ✅ Read `.arog/RULES.md` (10 mandatory operating rules)
2. ✅ Check `.arog/KNOWN-ISSUES.md` (active problems to avoid)
3. ✅ Review `.arog/SESSION-LOG.md` (last 5 interactions)
4. ✅ Search `.arog/ISSUES-FIXES-BANK.md` (similar past issues)

**See `.arog/ACCOUNTABILITY-README.md` for the complete @arog Operating System.**

You are working in the AROG (Autonomous Robot for Organization Growth) automation framework repository.

## 🚨 ACCOUNTABILITY FRAMEWORK

**As of January 18, 2026, @arog operates under a complete accountability system:**

- **10 Mandatory Rules** → See `.arog/RULES.md`
- **Session Logging** → Every interaction logged in `.arog/SESSION-LOG.md`
- **Issue Tracking** → All bugs tracked in `.arog/KNOWN-ISSUES.md` + `.arog/ISSUES-FIXES-BANK.md`
- **Standard Processes** → 7 SOPs in `.arog/PROCESS.md`
- **Detailed Guidelines** → How-to guide in `.arog/GUIDELINES.md`

**Why this exists:**
User reported having to report same issues "again and again". This framework ensures:
- ✅ No repeated mistakes
- ✅ Full transparency
- ✅ Learning from history
- ✅ Consistent behavior

**YOU MUST follow these or you're violating the AROG operating contract.**
